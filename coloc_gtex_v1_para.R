...
run_coloc_analysis <- function(PD_GWAS_v2_tidy, GTEx_PD_genes_eQTL_data_tidy_gene_filtered, priors_df, 
  ...
  write_delim(GTEx_PD_genes_eQTL_data_coloc_match_alleles_list[[2]], 
              str_c("/data/kronos/dzhang/coloc/results/GTEx/GTEx_raw_results_full", "/", tissue_formatted, "/", tissue_formatted, "_", 
...
GTEx_dir <- "/array/dkia/eqtl/gtex/Brain_regions_gtex_clean_id"
...
if(!file.exists("/data/kronos/dzhang/coloc/results/GTEx/GTEx_brain_regions_eQTL_df.csv")){
  ...
  write_delim(GTEx_brain_regions_eQTL_df, "/data/kronos/dzhang/coloc/results/GTEx/GTEx_brain_regions_eQTL_df.csv", delim = ",")

}else{

  GTEx_brain_regions_eQTL_df <- read_delim("/data/kronos/dzhang/coloc/results/GTEx/GTEx_brain_regions_eQTL_df.csv", delim = ",")
...
for(i in seq_along(GTEx_brain_regions_eQTL_df$path)){
  ...
  make_results_dir(results_path = "/data/kronos/dzhang/coloc/results/GTEx/GTEx_raw_results_full", tissue_formatted)
  ...
  for(index in START:END){
    ...
    if(index %in% seq_along(GTEx_ensembl_IDs_uniq)){
      ...
      save_coloc_results(coloc_results_gene, results_path = "/data/kronos/dzhang/coloc/results/GTEx/GTEx_raw_results_full", tissue_formatted, gene_to_filter)
